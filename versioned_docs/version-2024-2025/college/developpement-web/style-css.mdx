...
- Chaque rectangle correspond à un bloc qui pourra être:
  - `<div class=""></div>`
  - `<span class=""></span>`
  - ou un élément HTML avec un attribut `class` ou un `id`
...
:::info Regarde par ici, c'est important...
Voici un [Exemple](https://lucasdebeve.github.io/example-cv/tcg/) de carte Pokémon.