...
1. Ajouter une balise `<h1>` qui sera le nom de votre animal.
2. Ajouter une balise `<h2>` qui contiendra les mots : `Description physique`.
3. Ajouter une balise `<p>` qui contiendra la description physique de votre animal.
4. Ajouter une balise `<h2>` qui contiendra les mots : `Galerie d'images`.
5. Ajouter au moins 2 balises `<img>` qui contiendront des images de votre animal.
    - Au moins 1 image sera téléchargée sur votre ordinateur.
    - Au moins 1 image sera tiré d'un lien internet.
6. Ajouter un lien `<a href=...>` qui pointe vers la page Wikipédia de votre animal.
7. Au début de votre page, ajouter la balise `<nav>` qui représente le menu principal de votre page.
8. Dans le menu, ajouter un lien `<a href=...>` qui pointe vers le titre `Description physique` de votre page.
...
9. Dans le menu, ajouter un lien `<a href=...>` qui pointe vers le titre `Galerie d'images` de votre page.
