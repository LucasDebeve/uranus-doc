...
import { ConvertTrainer } from '@site/src/components/Markdown/BaseConverter';

<ConvertTrainer fromBase='décimale' toBaseChoice='binaire' />

<ConvertTrainer fromBase='décimale' toBaseChoice='hexadécimale' />

<ConvertTrainer fromBase='binaire' toBaseChoice='décimale' /> 

<ConvertTrainer fromBase='héxadécimale' toBaseChoice='décimale' /> 
